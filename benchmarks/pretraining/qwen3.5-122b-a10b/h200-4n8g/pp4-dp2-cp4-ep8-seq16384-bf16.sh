...
# 4 nodes x 8 H200, PP=4, DP=2, CP=4, EP=8, seq=16384, bf16.

# Launch command for running the benchmark from the root of this repository:
# srun_mcore --jobid=<id> -N4 --ntasks-per-node=1 -o logs/pretraining/qwen3.5-122b-a10b/h200-4n8g/pp4-dp2-cp4-ep8-seq16384-bf16-%J.log benchmarks/pretraining/qwen3.5-122b-a10b/h200-4n8g/pp4-dp2-cp4-ep8-seq16384-bf16.sh
...
MODEL_CONFIG[max-position-embeddings]=16384
