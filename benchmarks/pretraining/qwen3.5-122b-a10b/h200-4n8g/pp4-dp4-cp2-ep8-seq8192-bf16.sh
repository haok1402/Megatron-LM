...
# 4 nodes x 8 H200, PP=4, DP=4, CP=2, EP=8, seq=8192, bf16.

# Launch command for running the benchmark from the root of this repository:
# srun_mcore --jobid=<id> -N4 --ntasks-per-node=1 -o logs/pretraining/qwen3.5-122b-a10b/h200-4n8g/pp4-dp4-cp2-ep8-seq8192-bf16-%J.log benchmarks/pretraining/qwen3.5-122b-a10b/h200-4n8g/pp4-dp4-cp2-ep8-seq8192-bf16.sh
...
INFRA_CONFIG[context-parallel-size]=2
