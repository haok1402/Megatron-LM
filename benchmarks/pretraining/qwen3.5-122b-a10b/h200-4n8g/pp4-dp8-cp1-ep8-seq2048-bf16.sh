...
# 4 nodes x 8 H200, PP=4, DP=8, CP=1, EP=8, seq=2048, bf16.

# Launch command for running the benchmark from the root of this repository:
# srun_mcore --jobid=<id> -N4 --ntasks-per-node=1 -o logs/pretraining/qwen3.5-122b-a10b/h200-4n8g/pp4-dp8-cp1-ep8-seq2048-bf16-%J.log benchmarks/pretraining/qwen3.5-122b-a10b/h200-4n8g/pp4-dp8-cp1-ep8-seq2048-bf16.sh
