...
# 4 nodes x 8 H200, PP=4, DP=1, CP=8, EP=8, seq=32768, bf16.

# Launch command for running the benchmark from the root of this repository:
# srun_mcore --jobid=<id> -N4 --ntasks-per-node=1 -o logs/pretraining/qwen3.5-122b-a10b/h200-4n8g/pp4-dp1-cp8-ep8-seq32768-bf16-%J.log benchmarks/pretraining/qwen3.5-122b-a10b/h200-4n8g/pp4-dp1-cp8-ep8-seq32768-bf16.sh
...
MODEL_CONFIG[max-position-embeddings]=32768
...
INFRA_CONFIG[context-parallel-size]=8
INFRA_CONFIG[linear-cp-mode]=chunkwise
INFRA_CONFIG[linear-cp-layout]=contiguous
INFRA_CONFIG[expert-model-parallel-size]=8
INFRA_CONFIG[recompute-granularity]=selective
INFRA_CONFIG[recompute-modules]="moe core_attn layernorm"
...
INFRA_CONFIG[cuda-graph-modules]="attn"
